      ...
      <footer className="bg-gray-900 text-white">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Chung Tay Chống Ma Túy</h3>
              <p className="text-gray-400">Xây dựng cộng đồng mạnh mẽ, không ma túy thông qua hỗ trợ, giáo dục và hành động.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/workshops" className="text-gray-400 hover:text-white">Workshop</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              <h4 className="font-semibold mb-4">Cập Nhật Tin Tức</h4>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Chung Tay Chống Ma Túy. Bảo lưu mọi quyền.</p>
          </div>
        </div>
      </footer>
    </div>
